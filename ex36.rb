...
def ground_floor()
  ...
  if action.include? "door1"
    basement_room()
  elsif action.include? "door2"
    dead ("You go to up stair and the guard will kill you as you do not have enough weapon.")
  else
...
def basement_room()
  puts " In the basement you see lots of weapon on the shelf and another door in the basement room. What will you do?"
  prompt; action = gets.chomp
...
def up_stair()
  ...
  puts "You need to do something to go in to the second floor other wise the man will kill you."
...
def start()
  puts "You are going in a mission to rescue a queen that is held hostage by a group of Monsters on the out skirt of a city."
...
def guard_one()
  ...
  if action.include? "run"
    puts "You are a coward and have no courage to save the poor queen"
...
def man()
  ...
  if action.include? "run"
    ...
    puts "I do not know what you are trying to do and this doesn't make any sense. Try to do something useful again."
  end
end
...
def lion()
  ...
  puts "2. You will give the lion a meat to eat so that the lion will keep silent."
  ...
  if choice == "1"
    ...
    puts "You don't what you are getting in to. You failed any ways."
  end
end
...
def shooting()
  ...
  puts "B. Will hide my self and will kill the man."
  ...
  if action == "A"
    ...
    puts "You are not smart, you can not complete the game. Try again."
  end
end 
